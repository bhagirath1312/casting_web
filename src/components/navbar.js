...
//           {showAuthButtons && !["/login", "/signup"].includes(pathname) && (
//   <>
//     <button
//       onClick={() => router.push("/login")}
//       className="px-4 py-2 border border-black dark:border-gray-600 text-black dark:text-white rounded-lg hover:bg-[#5B408C] hover:text-white hover:border-[#5B408C] transition duration-300"
//     >
//       Login
//     </button>
...
//                     router.push("/login");
//                   }}
//                   className="px-4 py-2 border dark:border-gray-600 dark:text-white text-black rounded-lg"
//                 >
//                   Login
//                 </button>
//                 <button
...
//                     router.push("/signup");
//                   }}
//                   className="px-4 py-2 bg-[#5B408C] text-white rounded-lg hover:bg-[#4A3577]"
//                 >
//                   Sign Up
//                 </button>
//               </>
